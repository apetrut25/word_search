document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- 1. DOM & CONFIGURATION ---
    const GAME_VERSION = "1.1.4"; // Final feature: Dynamic Grid/Font Size
    ...
    function initGameSession() {
        // UPDATED: Load and apply saved grid size
    ...
    function startLevel() {
        ...
        // UPDATED: Read grid size from slider and set CSS variable
        ...
        if (gameState.bibleMode) {
            ...
            gameTitleEl.textContent = "Bible Search Wonderland";
