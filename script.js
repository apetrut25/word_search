document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- 1. DOM & CONFIGURATION ---
    const GAME_VERSION = "1.1.0"; // New feature: User-configurable grid size
    ...
    const gameWrapper = document.getElementById('game-wrapper'),
        ...
        gridSizeSlider = document.getElementById('grid-size-slider'), // NEW
        gridSizeValue = document.getElementById('grid-size-value'),   // NEW
    ...
    function startLevel() {
        ...
        // UPDATED: Read grid size from the slider
    ...
    // NEW: Event listener for the grid size slider
